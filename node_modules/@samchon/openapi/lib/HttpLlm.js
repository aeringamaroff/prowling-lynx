...
(function (HttpLlm) {
    ...
    HttpLlm.application = function (props) {
        ...
        return HttpLlmApplicationComposer_1.HttpLlmComposer.application({
            migrate: migrate,
            model: props.model,
            options: __assign(__assign({}, LlmSchemaComposer_1.LlmSchemaComposer.defaultConfig(props.model)), { separate: (_b = (_a = props.options) === null || _a === void 0 ? void 0 : _a.separate) !== null && _b !== void 0 ? _b : null, maxLength: (_d = (_c = props.options) === null || _c === void 0 ? void 0 : _c.maxLength) !== null && _d !== void 0 ? _d : null }),
        });
    };
    /**
