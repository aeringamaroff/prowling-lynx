...
(function (LlmSchemaV3Composer) {
    ...
    /* -----------------------------------------------------------
      INVERTERS
    ----------------------------------------------------------- */
    LlmSchemaV3Composer.invert = function (props) {
        var upgraded = OpenApiV3Upgrader_1.OpenApiV3Upgrader.convertSchema({})(props.schema);
        OpenApiTypeChecker_1.OpenApiTypeChecker.visit({
            closure: function (schema) {
                var _a, _b, _c;
                if (OpenApiTypeChecker_1.OpenApiTypeChecker.isArray(schema))
                    Object.assign(schema, __assign(__assign({}, LlmDescriptionInverter_1.LlmDescriptionInverter.array((_a = schema.description) !== null && _a !== void 0 ? _a : "")), schema));
                else if (OpenApiTypeChecker_1.OpenApiTypeChecker.isInteger(schema) ||
                    OpenApiTypeChecker_1.OpenApiTypeChecker.isNumber(schema))
                    Object.assign(schema, __assign(__assign({}, LlmDescriptionInverter_1.LlmDescriptionInverter.numeric((_b = schema.description) !== null && _b !== void 0 ? _b : "")), schema));
                else if (OpenApiTypeChecker_1.OpenApiTypeChecker.isString(schema))
                    Object.assign(schema, __assign(__assign({}, LlmDescriptionInverter_1.LlmDescriptionInverter.string((_c = schema.description) !== null && _c !== void 0 ? _c : "")), schema));
            },
            components: {},
            schema: upgraded,
        });
