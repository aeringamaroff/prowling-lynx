...
var HttpMigrateRouteAccessor_1 = require("./HttpMigrateRouteAccessor");
var HttpMigrateRouteComposer_1 = require("./HttpMigrateRouteComposer");
var HttpMigrateApplicationComposer;
(function (HttpMigrateApplicationComposer) {
    HttpMigrateApplicationComposer.compose = function (document) {
        var _a, _b;
        var errors = [];
        var entire = Object.entries(__assign(__assign({}, ((_a = document.paths) !== null && _a !== void 0 ? _a : {})), ((_b = document.webhooks) !== null && _b !== void 0 ? _b : {})))
            ...
            return ["head", "get", "post", "put", "patch", "delete"]
                ...
                var migrated = HttpMigrateRouteComposer_1.HttpMigrateRouteComposer.compose({
                    document: document,
                    method: method,
                    path: path,
