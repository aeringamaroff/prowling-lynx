...
(function (HttpMigrateRouteAccessor) {
    HttpMigrateRouteAccessor.overwrite = function (routes) {
        var e_1, _a;
        var predefined = getPredefinedAccessors(routes);
        ...
        var _loop_1 = function (props) {
            props.entries.forEach(function (entry, i) {
                ...
                var accessor = entry.route.operation()["x-samchon-accessor"];
    ...
    var getPredefinedAccessors = function (routes) {
        var e_3, _a;
        var _b;
        var dict = new Map();
        try {
            for (var routes_2 = __values(routes), routes_2_1 = routes_2.next(); !routes_2_1.done; routes_2_1 = routes_2.next()) {
                ...
                var accessor = (_b = r.operation()["x-samchon-accessor"]) === null || _b === void 0 ? void 0 : _b.join(".");
