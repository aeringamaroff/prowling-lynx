...
(function (OpenApiConstraintShifter) {
    OpenApiConstraintShifter.shiftArray = function (v) {
        var tags = [];
    ...
    OpenApiConstraintShifter.shiftNumeric = function (v) {
        var tags = [];
        ...
        if (v.minimum !== undefined && v.exclusiveMinimum === true) {
            tags.push("@exclusiveMinimum ".concat(v.minimum));
            delete v.minimum;
            delete v.exclusiveMinimum;
        }
        if (v.maximum !== undefined && v.exclusiveMaximum === true) {
            tags.push("@exclusiveMaximum ".concat(v.maximum));
            delete v.maximum;
    ...
    OpenApiConstraintShifter.shiftString = function (v) {
        var tags = [];
